...
NanoClaw / Claude Code 周报生成 Skill。从 GitHub 采集 PR 和 Issue 数据，自动生成给 leader 看的工作周报。
...
### 作为 NanoClaw Container Skill

将本目录复制到 NanoClaw 的 `container/skills/weekly-report/`，然后对机器人说"周报"。
